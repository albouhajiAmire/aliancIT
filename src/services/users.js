...
const Create = async (data , con) => {
  ...
  const Confirm = async (id) => {
    return  await  axios.put(`${Host.BACKEND}${ApiEndpoints.UserEndpoints.route}${ApiEndpoints.UserEndpoints.confirmEmail}/${id}`, { headers : {...config.headers  }  } )
  } 

  
export {
     Image , EditAccount , Delete , Create , Count , List , updateAccount , Confirm
}